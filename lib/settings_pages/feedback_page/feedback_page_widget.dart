...
class _FeedbackPageWidgetState extends State<FeedbackPageWidget> {
  ...
  void initState() {
    ...
    _model.textFieldUsernameTextController1 ??= TextEditingController();
    _model.textFieldUsernameFocusNode1 ??= FocusNode();

    _model.textFieldUsernameTextController2 ??= TextEditingController();
    _model.textFieldUsernameFocusNode2 ??= FocusNode();
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'honewby0' /* We’d love your feedback! */,
                                      ),
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'yropba2h' /* Help us improve your experienc... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .titleSmall
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            .textFieldUsernameTextController1,
                                        focusNode:
                                            _model.textFieldUsernameFocusNode1,
                                        autofocus: false,
                                        obscureText: false,
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'eya2fl7t' /* For example, you can give feed... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .titleSmall
                                            .override(
...
• Qui... */
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            .textFieldUsernameTextController2,
                                        focusNode:
                            ...
                            FFButtonWidget(
                              ...
                              text: FFLocalizations.of(context).getText(
                                'xbvwc7f1' /* Share feedback with us */,
                              ),
                              icon: Icon(
                                Icons.send_rounded,
