...
class SubscriptionPageWidget extends StatefulWidget {
  ...
  static String routePath = '/subscriptionMobile';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'fe68mxcd' /* Choose the plan that fits your... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                          ...
                                          Container(
                                            ...
                                            child: Align(
                                              alignment: AlignmentDirectional(
                                                  0.0, 0.0),
                                              child: StreamBuilder<
                                                  List<MySubscriptionRecord>>(
                                                stream:
                                                    queryMySubscriptionRecord(
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<MySubscriptionRecord>
                                                      textMySubscriptionRecordList =
                                                      snapshot.data!;
                                                  final textMySubscriptionRecord =
                                                      textMySubscriptionRecordList
                                                              .isNotEmpty
                                                          ? textMySubscriptionRecordList
                                                              .first
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'l7vit4ch' /* Unlimited quizzes and flashcar... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Switch.adaptive(
                                    value: _model.switchYearlyValue!,
                                    onChanged: (newValue) async {
                                      safeSetState(() =>
                                          _model.switchYearlyValue = newValue!);
                                    },
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'jtje8uo3' /* Unlimited quizzes and flashcar... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                              ...
                              children: [
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: FFLocalizations.of(context).getText(
                                      's7i2t98x' /* Manage my subscription */,
                                    ),
                                    options: FFButtonOptions(
                                      height: 45.0,
                                      padding: EdgeInsetsDirectional.fromSTEB(
