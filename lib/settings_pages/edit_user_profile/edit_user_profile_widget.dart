...
class EditUserProfileWidget extends StatefulWidget {
  const EditUserProfileWidget({
    super.key,
    required this.currentUserDocument,
  });
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  AuthUserStreamWidget(
                                    builder: (context) => Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode:
                                            _model.textFieldUsernameFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                          ...
                          if (currentUserDocument?.authMethod ==
                              AuthMethod.email)
                            Align(
                              alignment: AlignmentDirectional(0.0, -1.0),
                                ...
                                builder: (context) => Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'wu3ytaso' /* If changed, a verification lin... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                              ...
                              onPressed: () async {
                                if ((_model.textFieldEmailTextController.text !=
                                  ...
                                  if (_model.isValidated!) {
                                    ...
                                    await widget!.currentUserDocument!.reference
