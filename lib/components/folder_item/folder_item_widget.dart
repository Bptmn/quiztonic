...
import 'folder_item_model.dart';
export 'folder_item_model.dart';
...
class FolderItemWidget extends StatefulWidget {
  ...
  final FoldersRecord? folderItem;
...
class _FolderItemWidgetState extends State<FolderItemWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FolderItemModel());
                          ...
                          children: [
                            ...
                            TextSpan(
                              text: valueOrDefault<String>(
                                widget!.folderItem?.quizRefs?.length
                                    ?.toString(),
                                '0',
                              ),
                              style: FlutterFlowTheme.of(context)
