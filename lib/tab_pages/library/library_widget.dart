                        ...
                        children: [
                          ...
                          StreamBuilder<List<FoldersRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<FoldersRecord> containerFoldersRecordList =
                                  snapshot.data!;
                              ...
                              return Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: List.generate(folderItem.length,
                                          (folderItemIndex) {
                                        ...
                                        return InkWell(
                                          ...
                                          child: wrapWithModel(
                                            ...
                                            child: FolderItemWidget(
                                              key: Key(
                                                'Keywhy_${folderItemItem.userRef!.id}',
                                              ),
