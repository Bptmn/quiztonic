                          ...
                          children: [
                            Flexible(
                              child: StreamBuilder<UsersRecord>(
                                stream: FFAppState().currentUserAppLevel(
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'zqf451b8' /* Notification Settings */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyLarge
                                                ...
                                                if ((currentUserEmail == 'baptiste.veyrard@gmail.com') ||
                                                    (currentUserEmail ==
                                                        'pro.baptiste.veyrard@gmail.com') ||
                                                    (currentUserEmail ==
                                                        getRemoteConfigString(
                                                            'email_test')) ||
                                                    (currentUserEmail ==
                                                        'radoxa1976@oronny.com'))
                                                  InkWell(
                                                    splashColor:
                                                        Colors.transparent,
                                                    focusColor:
