...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ScorePageWidget(
            quizResult: params.getParam(
              ...
              ParamType.DataStruct,
              isList: false,
              structBuilder: QuizResultStruct.fromSerializableMap,
            ),
            flashcards: params.getParam<FlashcardStruct>(
              'flashcards',
              ParamType.DataStruct,
              isList: true,
        ...
        FFRoute(
          name: FlashcardsPageWidget.routeName,
          path: FlashcardsPageWidget.routePath,
          requireAuth: true,
          builder: (context, params) => FlashcardsPageWidget(
            generatedFlashCards: params.getParam<FlashcardStruct>(
              'generatedFlashCards',
              ParamType.DataStruct,
              isList: true,
              structBuilder: FlashcardStruct.fromSerializableMap,
